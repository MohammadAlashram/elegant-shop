...
if (isset($_POST['register'])) {
    ...
    if (!empty($userName) && !empty($userPassword) && !empty($userEmail)) {
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            $query = "insert into user(user_name,user_email,user_password,user_phone,user_image)
              values('$userName','$userEmail','$userPassword','$userMobile','$path$image_name')";
                ...
                <div class="register-form">
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div class="group-input">
                            ...
                            <input type="text" id="mobile" name="userMobile" required="required">
                        </div>
                        <div class="group-input">
